...
docker pull public.ecr.aws/u2n5q9y7/spring-petclinic-api-gateway:latest
docker tag public.ecr.aws/u2n5q9y7/spring-petclinic-api-gateway:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-api-gateway:latest
...
docker pull public.ecr.aws/u2n5q9y7/spring-petclinic-discovery-server:latest
docker tag public.ecr.aws/u2n5q9y7/spring-petclinic-discovery-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-discovery-server:latest
...
docker pull public.ecr.aws/u2n5q9y7/spring-petclinic-config-server:latest
docker tag public.ecr.aws/u2n5q9y7/spring-petclinic-config-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-config-server:latest
...
docker pull public.ecr.aws/u2n5q9y7/spring-petclinic-vets-service:latest
docker tag public.ecr.aws/u2n5q9y7/spring-petclinic-vets-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-vets-service:latest
...
docker pull public.ecr.aws/u2n5q9y7/spring-petclinic-customers-service:latest
docker tag public.ecr.aws/u2n5q9y7/spring-petclinic-customers-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-customers-service:latest
...
docker pull public.ecr.aws/u2n5q9y7/spring-petclinic-admin-server:latest
docker tag public.ecr.aws/u2n5q9y7/spring-petclinic-admin-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-admin-server:latest
